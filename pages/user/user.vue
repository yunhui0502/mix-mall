<template>  
    <view class="container">  
		...
		<view class="user-section">
			<image class="bg" src="/static/imgs/slices/h.png"></image>
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" :src="userInfo.portrait || '/static/missing-face.png'"></image>
				</view>
				<view class="info-box">
					<text class="username">{{'思创账号15155' || '游客'}}</text>
				</view>
			</view>
		...
		>
			...
			<view class="order-section">
				...
				<view class="order-item" @click="navTo('/pages/order/order?state=1')"  hover-class="common-hover" :hover-stay-time="50">
					...
					<image src="/static/imgs/slices/daifukuan.png" mode=""></image>
					<text>待付款</text>
				</view>
				<view class="order-item" @click="navTo('/pages/order/order?state=2')" hover-class="common-hover"  :hover-stay-time="50">
					<!-- <text class="yticon icon-yishouhuo"></text> -->
					<image src="/static/imgs/slices/daishouhuo.png" mode=""></image>
					<text>待收货</text>
				</view>
				<view class="order-item" @click="navTo('/pages/order/order?state=4')" hover-class="common-hover"  :hover-stay-time="50">
					<!-- <text class="yticon icon-shouhoutuikuan"></text> -->
					<image src="/static/imgs/slices/daipingjia.png" mode=""></image>
					<text>待评价</text>
				</view>
				<view class="order-item" @click="navTo('/pages/order/order?state=4')" hover-class="common-hover"  :hover-stay-time="50">
					<!-- <text class="yticon icon-shouhoutuikuan"></text> -->
					<image src="/static/imgs/slices/shouhou.png" mode=""></image>
					<text>售后</text>
				</view>
				
				<view class="order-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<!-- <text class="yticon icon-shouye"></text> -->
					<image src="/static/imgs/slices/dingdan.png" mode=""></image>
					<text>我的订单</text>
				</view>
			</view>
			<!-- 我的信息 商家 关注 -->
			<view class="message">
				...
				<view class="message-item" @click="navTo('/pages/userinfo/userinfo')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/yonghu.png" mode=""></image>
					<text>我的信息</text>
				</view>
				
				<view class="message-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/dianpu.png" mode=""></image>
					<text>我是商家</text>
				</view>
				
				<view class="message-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/star3.png" mode=""></image>
					<text>我的关注</text>
				</view>
				
				<view class="message-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/_wodezhangdan.png" mode=""></image>
					<text>我的账单</text>
				</view>
				
				<view class="message-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/wallet.png" mode=""></image>
					<text>我的钱包</text>
				</view>
			...
			<view class="history-section icon">
				...
				<view class="history-item" @click="navTo('/pages/address/address')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/dizhiguanli.png" mode=""></image>
					<text>地址管理</text>
				</view>
				
				<view class="history-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/wodepinglun.png" mode=""></image>
					<text>我的评论</text>
				</view>
				
				<view class="history-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/wenti.png" mode=""></image>
					<text>常见问题</text>
				</view>
				
				<view class="history-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/guanzhuwomen.png" mode=""></image>
					<text>关注我们</text>
				</view>
				
				<view class="history-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/lianxiwomen.png" mode=""></image>
					<text>联系我们</text>
				</view>
				
				<view class="history-item" @click="navTo('/pages/order/order?state=0')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="/static/imgs/slices/yijianfankui.png" mode=""></image>
					<text>意见反馈</text>
				</view>
